...
addI-commut Z n2 = equal-sym (addI-right n2)
addI-commut (S n1) n2 = equal-trans (addI-S n1 n2) (equal-sym (equal-trans (addI-S n2 n1) (case1  (addI-commut n2 n1))))

addI-n1 : (n1 n2 n3 : Nat) -> Equal n1 n2 -> Equal (addI n1 n3) (addI n2 n3)
addI-n1 Z Z n3 case0 = equal-refl n3
addI-n1 (S n1) (S n2) n3 (case1 p12) = addI-n1 n1 n2 ((S n3)) p12 

addI-assoc : (n1 n2 n3 : Nat) -> Equal (addI (addI n1 n2) n3) (addI n1 (addI n2 n3))
addI-assoc Z n2 n3 = equal-refl (addI n2 n3)
addI-assoc (S n1) n2 n3 = {!   !}

-- equivalence of addition functions (add as a pivot for properties)

addI-add : (n1 n2 : Nat) -> Equal (addI n1 n2) (add n1 n2)
addI-add n1 Z = equal-trans (addI-right n1) (equal-sym (add-right n1))
addI-add n1 (S n2) = equal-trans (addI-S n1 n2) (equal-sym (equal-trans (add-S n1 n2) (case1 (equal-sym (addI-add n1 n2)))))
