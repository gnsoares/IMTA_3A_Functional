...
addA-right Z = case0
addA-right (S n) = case1 (equal-refl n)

addA-commut : (n1 n2 : Nat) -> Equal (addA n1 n2) (addA n2 n1)
addA-commut Z n2 = equal-sym (addA-right n2)
addA-commut (S n1) Z = case1 (equal-trans (addA-commut Z n1) (addA-right n1))
addA-commut (S n1) (S n2) = case1 (case1 (addA-commut n1 n2)) 

add-addA : (n1 n2 : Nat) -> Equal (add n1 n2) (addA n1 n2)
add-addA Z n2 = equal-trans (add-commut Z n2) (add-right n2)
add-addA (S n1) n2 = case1 (equal-trans (add-commut n1 n2) (add-addA n2 n1))
